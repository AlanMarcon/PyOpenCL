...
'''
a = numpy.random.rand(7000,8000).astype(numpy.float32)
b = numpy.random.rand(7000,8000).astype(numpy.float32)
'''
a = numpy.random.rand(data_points).astype(numpy.float32)
b = numpy.random.rand(data_points).astype(numpy.float32)

c = numpy.random.rand(7000,8000).flatten().astype(numpy.float32)

print (a)
print (c)

#data_points = 7000*8000
#workers = 1
